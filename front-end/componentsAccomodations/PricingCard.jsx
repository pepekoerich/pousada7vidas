    ...
    <div className="p-4 border border-[#324b50] mt-10 lg:mt-0 text-[#324b50]">
      <div className="flex justify-between items-center border-b-2 border-[#324b50] pb-5">
        <div>
          ...
          <p className="lg:text-xl text-lg">Começando em R$350/noite</p>
        </div>
        <div>
          <h2 className="lg:text-5xl font-bold text-3xl">R$350/noite</h2>
        </div>
      </div>
      ...
      <div className="mt-5 flex justify-center">
        <Link href={"https://api.whatsapp.com/send?phone=5548999870064"}>
